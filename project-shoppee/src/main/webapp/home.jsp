        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid2">
                ...
                <div class="product-content">
                    ...
                    <span class="price">Rs.599.99</span>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
            <div class="product-grid2">
              <div class="product-image2">
                ...
                <div class="product-content">
                    ...
                    <span class="price">Rs.699.99</span>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid5">
                ...
                <div class="product-content">
                    ...
                    <div class="price">Rs.1,100 - Rs.1,500</div>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
            <div class="product-grid5">
                ...
                <div class="product-content">
                    ...
                    <div class="price">Rs.1,000 - Rs.1,200</div>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
...
<div class="container">
    <h3 class="h3">Shirts & Top's Collections </h3>
    <div class="row">
        <div class="col-md-3 col-sm-6">
...
<div class="container">
    <h3 class="h3"> Blazer and Shirts Collections </h3>
    <div class="row">
        <div class="col-md-3 col-sm-6">
...
<div class="container">
    <h3 class="h3">Women's Trending Collection </h3>
    <div class="row">
